        ...
        protected override void ProcessRecord()
        {
            try
            {
                ...
                WriteObject(new VTable
                {
                    ...
                    //
                    OnNewRequestV2 = ContextAdapter.Instance.OnNewRequestV2,
